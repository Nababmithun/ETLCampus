...
public class AppinmentOfOtherStuffActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, AdapterView.OnItemSelectedListener{
    ...
    private void setSpinner1() {
        ...
        spinner.setOnItemSelectedListener(AppinmentOfOtherStuffActivity.this);
    }
    ...
    private void createPublicHearing() {
        ...
        if (subject.isEmpty()) {
            ...
            final ProgressDialog mDialog = new ProgressDialog(AppinmentOfOtherStuffActivity.this);
            ...
            call.enqueue(new Callback<PublicHearingSaveResponse>() {
                ...
                public void onResponse(Call<PublicHearingSaveResponse> call, Response<PublicHearingSaveResponse> response) {
                    ...
                    if (response.code() == 200) {
                        ...
                        Toast.makeText(AppinmentOfOtherStuffActivity.this, "Congratulations!! Your data saved successfully "+meg.getMessage(), Toast.LENGTH_LONG).show();
                        mDialog.dismiss();
