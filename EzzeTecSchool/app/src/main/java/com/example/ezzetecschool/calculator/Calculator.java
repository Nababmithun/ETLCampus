package com.example.ezzetecschool.calculator;
...
import com.example.ezzetecschool.R;
import com.google.android.material.tabs.TabLayout;



public class Calculator extends AppCompatActivity implements AgeFragment.OnFragmentInteractionListener {
    ...
    private void toolbarAndViewPager() {

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);


        //adding app logo to toolbar
...
//        Log.v("onFragmentInteraction", "d: " + day + " m: " + month);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return getString(R.string.agee);
                case 1:
